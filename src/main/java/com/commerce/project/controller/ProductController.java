...
import com.commerce.project.config.AppConstants;
...
public class ProductController {
    ...
    public ResponseEntity<ProductDTO> addProduct(@Valid @RequestParam ProductDTO productDTO, @PathVariable Long categoryId) {
    ...
    public ResponseEntity<ProductDTO> updateProduct(@Valid @RequestParam ProductDTO productDTO, @PathVariable Long productId) {
